...
//			log.debug("Bowser launched");
	//		String URL=config.getProperty("testsiteurl");
		//	System.out.println(" print URL==="+URL);
			...
			{
				System.setProperty("webdriver.gecko.driver", "E:\\class\\softwares\\soft2\\geckodriver_64\\geckodriver.exe");
...
/*
	public void setUp() {
		...
		if (driver == null) {
			...
			try {
				fis = new FileInputStream(
						...
						System.getProperty("C:\\Users\\HP\\eclipse-workspaceRNT\\RNTReportNG\\resources\\Properties\\Config.properties"));
			...
			try {
				fis =  new FileInputStream(
						...
						System.getProperty("C:\\Users\\HP\\eclipse-workspaceRNT\\RNTReportNG\\resources\\Properties\\OR.properties"));
			} catch (FileNotFoundException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
		...
		/*		
			System.getProperty("webdriver.chrome.driver" + "C:\\Users\\HP\\eclipse-workspaceRNT\\DataDrivenFramework- updated code\\src\\test\\resources\\executables\\chromedriver.exe");
				driver = new ChromeDriver();
